---
title: "Diverse Cohorts RNA-Seq Regression (Columbia)"
author: "Jaclyn Beck"
format:
  html:
...
```{r}
lapply(clean_covariates, function(covariates) {
  cor(select(covariates, DV200, RIN, PMI))
})
```
...
formulas <- list(
  "Columbia" = list(
    "caudate nucleus" = "~ DV200 + PMI",
    "dorsolateral prefrontal cortex" = "~ DV200 + PMI",
    "temporal pole" = "~ DV200 + PMI"
  )
)
```
